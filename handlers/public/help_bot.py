...
def generate_help_page(page: str) -> str:
    help_texts = {
        "page1": (
            ...
            "<code>!view-admins</code> — Список администраторов, и всех ролей на сервере.\n"
        ...
        "page2": (
            ...
            "<code>!grant</code> — Назначить администратора\n"
            "<code>!revoke</code> — Удалить администратора\n"
            "<code>!edit-admin</code> — Открывает полное управление ролью\n"
            "<code>!new-role</code> — Создает роль\n"
            "<code>!remove-role</code> — Удаляет роль\n"
